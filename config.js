var config = {
    ...
    chapters: [
        {
            id: 'all',
            title: "Detroit's GIS Projects",
            image: 'https://detroitstormwater.org/themes/custom/compro_theme/logo.png',
            description: "According to the Detroit Stormwater Hub, there are 202 GIS projects in Detroit, categorized under 15 different types. Here are all the GIS sites in Detroit, but let's break this down a little.",
            location: {
        ...
        },
        {
            ...
            description: 'The most common type of GIS in Detroit is “disconnected impervious” These sites manage stormwater by directing runoff from impervious surfaces onto properly sized, sloped, and vegetated surfaces, that stop storm water from traveling in the future and polluting other services. 88 of the GIS projects in Detroit are of this type. ',
            location: {
                center: [-83.18441, 42.39703],
                zoom: 10.53,
                pitch: 45.00,
        ...
        },
        {
            ...
            title: 'Belle Isle',
            image: './path/to/image/source.png',
            description: 'The largest disconnected impervious site is a drange credit project built on Bell Isle, which reports to mangae 16.65 million gallons of water annually. This project which was designed and implemented by Parjana Distribution, a detroit-based Water Management engineering company in 2014, and for some parts of the island showed a 80% reduction in the total amount of runoff. ',
            location: {
        ...
        },
        {
            ...
            image: './path/to/image/source.png',
            description: 'The next most common type of GIS is “Downspout Disconnection” where rather than having - roof downspouts lead to a sewer system they are redirected to something that can absorb the excess water, like a lawn. These tend to handle much less water than disconnected Impervious sites, the largest one reported managing 120,000 gallons of water annually in Delray, its located at the site of All Saints Soup Kitchen. There are 35 of this type of site across Detroit. ',
            location: {
                center: [-83.18441, 42.39703],
                zoom: 10.53,
                pitch: 45.00,
        ...
        },
        {
            ...
            title: 'Bioretention',
            image: './path/to/image/source.png',
            description: 'The largest bioretention site in the city is also an interesting case. It is located at Sacred Heart Church parking lot, and was created as part of a partnership between the church and the Nature conservatory. The Site Magges 2.03 million gallons of water annually, by reducing runoff into small garden plots rather than the sewers.',
            location: {
        ...
        },
        {
            ...
            image: './path/to/image/source.png',
            description: "While this was not a comprehensive tour of all 202 of detroit GIS sites...",
            location: {
                center: [-83.18441, 42.39703],
                zoom: 10.53,
                pitch: 45.00,
